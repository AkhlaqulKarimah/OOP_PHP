...
class pesawat extends kendaraan
{
	...
	$pesawat1 -> pemilik = 'Garuda Indonesia';
	$pesawat1 -> harga='2000000';
	$pesawat1 -> setTinggiMaks('7500');
	$pesawat1 -> setKecepatanMaks('650');
	echo 'Biaya operasional pesawat '.$pesawat1 -> merk.' dengan pemiliknya adalah '.$pesawat1 -> pemilik.' yang memiliki tinggi maksimum '.$pesawat1 ->bacaTinggiMaks().' feet dan kecepatan maksimum '.$pesawat1 ->bacaKecepatanMaks().'  km/jam adalah Rp. '.$pesawat1 ->biayaOperasional();
	echo "<p/>";

	$pesawat2 = new pesawat();
	$pesawat2 -> merk="Boeing 747";
	$pesawat2 -> pemilik="Citilink";
	$pesawat2 -> harga='3500000';
	$pesawat2 -> setTinggiMaks('5800');
	$pesawat2 -> setKecepatanMaks('750');
	echo 'Biaya operasional pesawat '.$pesawat2 ->merk.' dengan pemiliknya adalah '.$pesawat2 -> pemilik.' yang memiliki tinggi maksimum '.$pesawat2 ->bacaTinggiMaks().' feet dan kecepatan maksimum '.$pesawat2 ->bacaKecepatanMaks().'  km/jam adalah Rp. '.$pesawat2 ->biayaOperasional();
	echo "<p/>";

	$pesawat3 = new pesawat();
	$pesawat3 -> merk="Cassa";
	$pesawat3 -> pemilik = "Batik Air";
	$pesawat3 -> harga='750000';
	$pesawat3 -> setTinggiMaks('3500');
	$pesawat3 -> setKecepatanMaks('500');
	echo 'Biaya operasional pesawat '.$pesawat3 ->merk.' dengan pemiliknya adalah '.$pesawat3 -> pemilik.' yang memiliki tinggi maksimum '.$pesawat3 ->bacaTinggiMaks().' feet dan kecepatan maksimum '.$pesawat3 ->bacaKecepatanMaks().'  km/jam adalah Rp. '.$pesawat3 ->biayaOperasional();
