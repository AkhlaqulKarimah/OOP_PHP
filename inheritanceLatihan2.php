...
class pesawat extends kendaraan
{
	...
	echo 'Biaya operasional pesawat '.$pesawat1 ->bacaMerk().' yang memiliki tinggi maksimum '.$pesawat1 ->bacaTinggiMaks().' feet dan kecepatan maksimum '.$pesawat1 ->bacaKecepatanMaks().'  km/jam adalah Rp. '.$pesawat1 ->bacaHarga();
	echo "<p/>";
	...
	echo 'Biaya operasional pesawat '.$pesawat2 ->bacaMerk().' yang memiliki tinggi maksimum '.$pesawat2 ->bacaTinggiMaks().' feet dan kecepatan maksimum '.$pesawat2 ->bacaKecepatanMaks().'  km/jam adalah Rp. '.$pesawat2 ->bacaHarga();
	echo "<p/>";
	...
	echo 'Biaya operasional pesawat '.$pesawat3 ->bacaMerk().' yang memiliki tinggi maksimum '.$pesawat3 ->bacaTinggiMaks().' feet dan kecepatan maksimum '.$pesawat3 ->bacaKecepatanMaks().'  km/jam adalah Rp. '.$pesawat3 ->bacaHarga();
